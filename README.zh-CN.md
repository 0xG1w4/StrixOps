...
**默认分支 `main` 已与 `v1.3.5-release` 同步，均为当前维护的 1.3.5 稳定版本**；`v1.4.0-dev` 分支已移除。已纳入与未纳入的改动见[稳定基线范围](docs/v1.3.5.md#stable-baseline-scope)。
...
已有的 `main` 安装可执行 `git pull --ff-only`，更新到相同的 1.3.5 稳定版本。
