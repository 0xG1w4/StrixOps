...
以应用代码 `85d980b` 为基底，仅更新版本元数据和文档，保留原有程序逻辑、提示词和技能内容。
`v1.3.5` 标签保留为固定历史快照；**`main` 和 `v1.4.0-dev` 属于开发版本**。
本次未纳入的后续改动见[稳定基线范围](docs/v1.3.5.md#stable-baseline-scope)。
...
如需固定历史快照，可使用保留的 `v1.3.5` 标签，其完整引用为 `refs/tags/v1.3.5`。
