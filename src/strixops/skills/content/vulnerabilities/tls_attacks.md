---
name: tls_attacks
description: TLS/SSL attack methodology — enumeration and scanning, protocol downgrade, BEAST, CRIME/BREACH, Heartbleed, certificate validation bypass and pinning bypass. Use when transport weaknesses are suspected or reported.
---

Transport-layer attacks only against in-scope targets; active decryption/downgrade attacks need engagement scope that permits them.

# TLS Attack Methodology
