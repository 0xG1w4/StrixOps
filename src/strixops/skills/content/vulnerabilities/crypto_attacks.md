---
name: crypto_attacks
description: Applied cryptography attacks — padding oracles, ECB block manipulation, hash length extension, weak RSA, PRNG prediction, timing side channels, AES-GCM nonce reuse. For application crypto flaws found during web or API testing.
---
