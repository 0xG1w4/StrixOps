---
name: osint
description: OSINT methodology for authorized engagements — infrastructure and attack-surface discovery, username/email and credential intelligence, public records, breach-notification data as leads. Complements passive asset discovery in reconnaissance/asset_discovery.
---

OSINT is engagement intelligence: collect what feeds the authorized assessment — infrastructure mapping, naming schemes, seed credentials for validation, exposure of in-scope assets. Operate on public sources only, never contact or deceive people, treat every OSINT hit as a lead to validate against in-scope systems, and keep personal data minimal and out of reports unless it is directly security-relevant.

# OSINT Methodology (Authorized Engagements)
