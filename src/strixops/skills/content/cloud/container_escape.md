...
description: Full container escape methodology — detection and enumeration, privileged breakout, docker socket abuse, capability-based escapes, cgroup v1 notify_on_release, runtime CVEs (runc/containerd), kernel exploits from inside a container.
---

Quick in-container triage also lives in internal/privilege_escalation_linux; this file is the complete escape methodology. Targets must be in the authorized scope.
