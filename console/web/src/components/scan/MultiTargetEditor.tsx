...
const COPY = {
  "zh-CN": {
    ...
    description: "每个目标建立独立任务、容器与报告；目标之间不共享分析上下文。",
    import: "导入 .txt",
  ...
  en: {
    ...
    description: "Each target gets its own task, container, context and report. Targets are assessed independently.",
    import: "Import .txt",
    ...
    tooMany: "A batch supports up to 100 different targets. Shorten the list to continue.",
